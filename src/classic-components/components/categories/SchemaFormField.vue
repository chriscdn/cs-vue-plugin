<template>
    <div :class="{ 'has-errors': hasErrors }">
        ...
        <DatePicker v-else-if="lwidget == 'date'" v-model="valueLocal" :enable-time="false" :format="formatDateString" :editable="editable" />
        <DatePicker v-else-if="lwidget == 'datetime'" v-model="valueLocal" :enable-time="true" :format="formatDateTimeString" :editable="editable" />
        <input v-else v-model="valueLocal" type="search" :maxlength="maxLength" :readonly="isReadOnly" />
        <!-- </slot> -->
