<template>
  <div :class="{ 'has-errors': hasErrors }">
    ...
    <UserPicker
      v-else-if="lwidget == 'user'"
      v-model="valueLocal"
      :groups="false"
      :editable="editable"
    />
    <UserPicker
      v-else-if="lwidget == 'usergroup'"
      v-model="valueLocal"
      :groups="true"
      :editable="editable"
    />
    <DatePicker
      v-else-if="lwidget == 'date'"
      v-model="valueLocal"
      :enableTime="false"
...
export default {
  ...
  computed: {
    ...
    isUserGroupPicker() {
      return (
        this.fieldTypeArray.includes('integer') && this.format == 'usergroup'
      )
    },
    isDatePicker() {
    ...
    isDateTimePicker() {
      return (
        this.fieldTypeArray.includes('string') && this.format == 'date-time'
      )
    },
    errors() {
