<template>
    <span v-if="dataid">
        <a :id="aid" href="#" class="functionMenuHotspot" @click.prevent="onclick">
            ...
            <img v-else :id="xid" :src="image" border="0" alt="Functions" title="Functions" @mouseover="onmouseover" @mouseout="onmouseout" />
        </a>
        <div v-once :id="zid" ref="functionMenuDiv" class="functionMenuDiv"></div>
    </span>
</template>
<script>
export default {
