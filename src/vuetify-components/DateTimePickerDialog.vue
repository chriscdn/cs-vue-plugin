		...
		<v-card v-if="dialog">
			...
			<v-card-text class="pa-0">
				...
				<v-tabs-items v-model="tabs">
					<v-tab-item id="date">
						<v-date-picker no-title v-model="localDateValue" :locale="this.$language.current" scrollable full-width></v-date-picker>
					</v-tab-item>
					<v-tab-item id="time">
						<v-time-picker ref="timePicker" no-title v-model="localTimeValue" format="24hr" :locale="this.$language.current" scrollable full-width></v-time-picker>
					</v-tab-item>
				</v-tabs-items>
			</v-card-text>
			<v-card-actions>
